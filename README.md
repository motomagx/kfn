KFN é um assistente de customização do Kernel Linux, screito em Shell, permitindo a compilação para multi-plataformas, suportando múltiplos compiladores (suporte parcial no momento).
